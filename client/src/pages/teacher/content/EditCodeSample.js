...
import EditingCodeSampleEditor from './EditingCodeSampleEditor';

class EditCodeSample extends Component {
	...
	render() {
		...
		return (
			...
			<div id="create-a-course-container">
			  <h1>Edit a Code Sample for {this.state.title}</h1>

				<EditingCodeSampleEditor />
...
export default function(props) {
	...
	return <EditCodeSample navigate={navigate} params={params} />;
