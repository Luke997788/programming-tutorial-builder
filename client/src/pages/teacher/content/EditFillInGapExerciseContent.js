...
class EditFillInTheGapExerciseContent extends Component {
    ...
    async updateExerciseAnswers() {
        ...
        const response = await fetch('/api/updateexerciseanswers', {
            ...
            body: JSON.stringify({ contentId: this.state.contentId, courseId: this.state.courseId, task: this.taskContent, answer1: this.exerciseAnswers, correctAnswer: this.exerciseAnswers, correctMessage: this.state.correctFeedbackMessage, incorrectMessage: this.state.incorrectFeedbackMessage}),
        });
    ...
    async updateTestExerciseInformation() {
        ...
        const response = await fetch('/api/updatetestexercise', {
            ...
            body: JSON.stringify({testId: this.state.testId, exerciseId: this.state.contentId, title: this.state.contentTitle, content: this.taskContent, correctMessage: this.state.correctFeedbackMessage, incorrectMessage: this.state.incorrectFeedbackMessage}),
        });
